    ...
    <div className="lg:h-[88vh] bg-[#62269d] md:h-[80vh] sm:h-[75vh] h-[70vh] flex items-center justify-center flex-col">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 items-center w-4/5 mx-auto">
        ...
        <div className="col-span-2">
          <h1
            data-aos="fade-right"
            className="text-[27px] md:text-[35px] lg:text-[40px] mb-4 font-bold text-white leading-[2.4rem] md:leading-[4rem]"
          >
          ...
          >
            ...
            similique quas error molestiae dolorum! Molestias iste cumque modi
            ex.
          </p>
          {/* {input box} */}
          <div
          ...
          <button
            data-aos="zoom-out"
            data-aos-delay="600"
            className="px-4 py-2 w-[40%] bg-blue-500 hover:bg-blue-700 transition-all duration-150 rounded-full mt-4 text-white"
          >
            Submit
          </button>
        </div>
