...
const PriceCard = ({
  ...
  return (
    <div className={`${bg} p-6 text-center rounded-lg`}>
      <h1 className="text-white text-[17px] md:text-[20px] mt-8 ">
        After {days} days
      </h1>
      <h1
        className={`w-4/5 mx-auto ${percentageColor} text-white text-[23px] font-bold p-4 rounded-lg mt-6`}
      >
        {percentage}%
      </h1>

      <h1 className="text-white mt-4 mb-4 ">Minimum Invest : ${minInvest}</h1>

      <h1 className="text-white mt-4 mb-4">Maximum Invest : ${maxInvest}</h1>
